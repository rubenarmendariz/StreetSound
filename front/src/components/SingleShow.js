...
export default class SingleProfile extends Component {
   constructor(props){
    ...
    render() {
        // console.log(this.props.location.coordinates[0])
        // console.log(this.props.location.coordinates[1])
    ...
    // let { name, email} = this.props;
        return(
            <div>
               ...
               {/* <h1>{this.props.location.coordinates[0]}</h1>
               <h2>{this.props.location.coordinates[1]}</h2> */}
